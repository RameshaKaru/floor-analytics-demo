...
var getHistoricalData1 = function (action,tableName, timeFrom) {
        var providerData = null;
        var providerUrl = context + '/api/batch-provider?action=' + action + '&tableName=' + tableName +
...
$(document).ready(function () {
    ...
    $('input[name="daterange"]').datepicker({
        ...
        var difInHrs = (currentDate1 - date)/3600000 ;
        date.setHours(date.getHours()-1);

        if(difInHrs < 6){
            historicalData = getHistoricalData1("getHistoricalData","ORG_WSO2_FLOOR_SUMMARIZED6HR_PERFLOOR_SENSORSTREAM", date.getTime());

        }else if (difInHrs < 24){
            historicalData = getHistoricalData1("getHistoricalData","ORG_WSO2_FLOOR_SUMMARIZED_PERFLOOR_SENSORSTREAM", date.getTime());

        }else if (difInHrs < 168){
            historicalData = getHistoricalData1("getHistoricalData","ORG_WSO2_FLOOR_SUMMARIZED1HR_PERFLOOR_SENSORSTREAM", date.getTime());

        }else{
            historicalData = getHistoricalData1("getHistoricalData","ORG_WSO2_FLOOR_SUMMARIZED3HR_PERFLOOR_SENSORSTREAM", date.getTime());
